...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function() {
        ...
        cy.get('#firstName').type('Jonatán')
        cy.get('#lastName').type('Odilon')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        cy.get('#firstName').type('Jonatán').should('have.value', 'Jonatán')
    ...
    it('utiliza no lugar do .get o .contains no button', function() {
        cy.get('#firstName').type('Jonatán')
        cy.get('#lastName').type('Odilon')
        cy.get('#email').type('teste@teste,com')
        cy.get('#open-text-area').type('Teste')
    ...
    it('marca ambos checkboxes, depois desmarca o último', function() {
        cy.get('input[type="checkbox"]').check().should('be.checked').last()
